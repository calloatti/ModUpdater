...
internal static class CSteamGameServerAPIContext
{
	...
	internal static bool Init()
	{
		...
		using (InteropHelp.UTF8StringHandle ver = new InteropHelp.UTF8StringHandle("SteamClient018"))
		{
		...
		m_pSteamUGC = SteamGameServerClient.GetISteamUGC(hSteamUser, hSteamPipe, "STEAMUGC_INTERFACE_VERSION012");
